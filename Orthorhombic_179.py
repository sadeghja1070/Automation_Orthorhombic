...
n = 3 # number of layers of crystal along x and y (right now its 2 layer along z)
...
def ThirdLayer(molecule):# Makes the third layer of the crystal
    ...
    if Z == 1:
        ...
        for m in molecule:
            ...
            #
            #    *************************************Z = Same layer*****************************************
            #First circle ((Xn - a/2) , (Yn - b/2) , (Zn))
            result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
            result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
            result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            ###
            #Second Circle ((X - a) , (Y - b) , (Z))
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y),7)),(precision((m.z),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z),7))])
            result.append([m.name,(precision((m.x),7)),(precision((m.y-float(b)),7)),(precision((m.z),7))])
            ...
            result.append([m.name,(precision((m.x+float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z),7))])
            ###
            #Third circle ((Xn - (3a/2)) , (Yn - (3b/2)) , (Zn))
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn-float((3.0 * b)/2.0)),7)),(precision((zn),7))])
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn+float((3.0 * b)/2.0)),7)),(precision((zn),7))])
            ...
            result.append([m.name,(precision((m.x+float(2.0 * a)),7)),(precision((m.y+float(2.0 * b)),7)),(precision((m.z),7))])
            ###
            #Fifth circle ((Xn - (5a/2)) , (Yn - (5b/2)) , (Zn))
            ...
            #result.append([m.name,(precision((m.x-float(3.0 * a)),7)),(precision((m.y-float(b)),7)),(precision((m.z),7))])
            ...
            #result.append([m.name,(precision((m.x-float(2.0 * a)),7)),(precision((m.y+float(3.0 * b)),7)),(precision((m.z),7))])
            #
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y-float(3.0 * b)),7)),(precision((m.z),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y+float(3.0 * b)),7)),(precision((m.z),7))])
            ...
            #
            ###
            #7th circle ((Xn - (7a/2)) , (Yn - (b/2)) , (Zn))
            ##result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn-float((7.0 * b)/2.0)),7)),(precision((zn),7))])
            ##result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn+float((7.0 * b)/2.0)),7)),(precision((zn),7))])
            ##result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn-float((7.0 * b)/2.0)),7)),(precision((zn),7))])
            ##result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn+float((7.0 * b)/2.0)),7)),(precision((zn),7))])
            #
            #***********************************************  Z = Z+c************************************************************* 
            #Main Molecule((x),(y),(z+c))
            result.append([m.name,(precision((m.x),7)),(precision((m.y),7)),(precision((m.z+float(c)),7))])
            #
            #First circle ((Xn - a/2) , (Yn - b/2) , (Zn + c))
            result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+float(c)),7))])
            result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+float(c)),7))])
            result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+float(c)),7))])
            result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+float(c)),7))])
            #
            #Second Circle ((X - a) , (Y - b) , (Z + c))
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z+float(c)),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y),7)),(precision((m.z+float(c)),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z+float(c)),7))])
            result.append([m.name,(precision((m.x),7)),(precision((m.y-float(b)),7)),(precision((m.z+float(c)),7))])
            ...
            result.append([m.name,(precision((m.x+float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z+float(c)),7))])
            #
            #Third circle ((Xn - (3a/2)) , (Yn - (3b/2)) , (Zn + c))
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn-float((3.0 * b)/2.0)),7)),(precision((zn+float(c)),7))])
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+float(c)),7))])
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+float(c)),7))])
            result.append([m.name,(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn+float((3.0 * b)/2.0)),7)),(precision((zn+float(c)),7))])
            ...
            ##result.append([m.name,(precision((m.x+float(2.0 * a)),7)),(precision((m.y+float(2.0 * b)),7)),(precision((m.z+float(c)),7))])
            #
            #Fifth circle ((Xn - (5a/2)) , (Yn - (5b/2)) , (Zn + c))
            #
            ...
            #result.append([m.name,(precision((m.x-float(3.0 * a)),7)),(precision((m.y-float(b)),7)),(precision((m.z+float(c)),7))])
            ...
            #result.append([m.name,(precision((m.x-float(2.0 * a)),7)),(precision((m.y+float(3.0 * b)),7)),(precision((m.z+float(c)),7))])
            #
            ##result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y-float(3.0 * b)),7)),(precision((m.z+float(c)),7))])
            ##result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y+float(3.0 * b)),7)),(precision((m.z+float(c)),7))])
            ...
            #
            ####
            #7th circle ((Xn - (7a/2)) , (Yn - (b/2)) , (Zn+c))
            ##result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn-float((7.0 * b)/2.0)),7)),(precision((zn+float(c)),7))])
            ##result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn+float((7.0 * b)/2.0)),7)),(precision((zn+float(c)),7))])
            ##result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn-float((7.0 * b)/2.0)),7)),(precision((zn+float(c)),7))])
            ##result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn+float((7.0 * b)/2.0)),7)),(precision((zn+float(c)),7))])
            #
            ...
            #
            #***********************************************  Z = Z+2c*************************************************************
            #Main molecule((x),(y),(z + 2c))
            result.append([m.name,(precision((m.x),7)),(precision((m.y),7)),(precision((m.z+float(2.0 * c)),7))])
            #
            #First circle ((Xn - a/2) , (Yn - b/2) , (Zn + 2c))
            result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+float(2 * c)),7))])
            result.append([m.name,(precision((xn-float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+float(2 * c)),7))])
            result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+float(2 * c)),7))])
            result.append([m.name,(precision((xn+float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+float(2 * c)),7))])
            #
            #
            #Second Circle ((X - a) , (Y - b) , (Z + 2c))
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x-float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x),7)),(precision((m.y-float(b)),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x),7)),(precision((m.y+float(b)),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x+float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x+float(a)),7)),(precision((m.y),7)),(precision((m.z+float(2 * c)),7))])
            result.append([m.name,(precision((m.x+float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z+float(2 * c)),7))])
...
with open('Sources//d2k-batch.run','r') as file:
    with open('Sources//d2k-batch.run','r+') as file2:
        for line in file:
            file2.write(line.replace('Sadegh-Shokatian',Nn))
file.close()
file2.close()
...
for i in range(n_carbon):
    ...
    shutil.copy2('Sources//xray.inp', ff+'//c'+str(i))
    shutil.copy2('Sources//xray2k.run', ff+'//c'+str(i))
    shutil.copy2('Sources//xray2k.x', ff+'//c'+str(i))
aa = os.curdir

with open('Sources//d2k-batch.run','r') as file:
    with open('Sources//d2k-batch.run','r+') as file2:
        for line in file:
            file2.write(line.replace(Nn,'Sadegh-Shokatian'))
file.close()
file2.close()
###
