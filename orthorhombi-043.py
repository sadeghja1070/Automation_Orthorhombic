...
def SecondLayer(molecule):# Makes the second layer of the crystal
    ...
    if Z == 1:
        ...
        for m in molecule:
            ...
            yn = round(m.x ,7)
            zn = round(m.z,7)
            result.append([(m.name+str(3)),(precision((xn-float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(3)),(precision((xn-float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(3)),(precision((xn+float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(3)),(precision((xn+float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(3)),(precision((m.x),7)),(precision((m.y),7)),(precision((m.z+ float(c)),7))])
            result.append([(m.name+str(3)),(precision((m.x),7)),(precision((m.y),7)),(precision((m.z- float(c)),7))])
            #
            result.append([(m.name+str(4)),(precision((xn-float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+ float(c)),7))])
            result.append([(m.name+str(4)),(precision((xn-float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+ float(c)),7))])
            result.append([(m.name+str(4)),(precision((xn+float(a/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn+ float(c)),7))])
            result.append([(m.name+str(4)),(precision((xn+float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn+ float(c)),7))])
            result.append([(m.name+str(4)),(precision((xn-float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn- float(c)),7))])
            ...
            result.append([(m.name+str(4)),(precision((xn+float(a/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn- float(c)),7))])
            #
            result.append([(m.name+str(5)),(precision((m.x-float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x-float(a)),7)),(precision((m.y),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x-float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x),7)),(precision((m.y+float(b)),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x+float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x+float(a)),7)),(precision((m.y),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x+float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x),7)),(precision((m.y-float(b)),7)),(precision((m.z),7))])
            result.append([(m.name+str(5)),(precision((m.x-float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x-float(a)),7)),(precision((m.y),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x-float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x),7)),(precision((m.y+float(b)),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x+float(a)),7)),(precision((m.y+float(b)),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x+float(a)),7)),(precision((m.y),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x+float(a)),7)),(precision((m.y-float(b)),7)),(precision((m.z + float(c)),7))])
            result.append([(m.name+str(5)),(precision((m.x),7)),(precision((m.y-float(b)),7)),(precision((m.z + float(c)),7))])
            ...
            result.append([(m.name+str(5)),(precision((m.x),7)),(precision((m.y-float(b)),7)),(precision((m.z - float(c)),7))])
            #
            result.append([(m.name+str(6)),(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(6)),(precision((xn-float((3.0 * a)/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(6)),(precision((xn+float((3.0 * a)/2.0)),7)),(precision((yn+float(b/2.0)),7)),(precision((zn),7))])
            result.append([(m.name+str(6)),(precision((xn+float((3.0 * a)/2.0)),7)),(precision((yn-float(b/2.0)),7)),(precision((zn),7))])
    else:
...
'''
Choose Title of the input file
'''

NewTitle = raw_input('Please enter a title for your input file?'+'\n')
newTitleupper = NewTitle.upper()

with open('Sources//input.txt','r') as batch:
    with open('Sources//input2.txt','w') as batch2:
        for line in batch:
            batch2.write(line.replace('SadeghShokatian',newTitleupper))
batch.close()
batch2.close()
...
for c_counter in range(n_carbon):
    attempt = 0
    with open('Sources//molecule.xyz','r') as file:
        with open('Sources//input2.txt','r') as infile:
            with open(ff+'//c'+str(c_counter)+'//c'+str(c_counter)+'.inp','w') as new:
                for line in file:
                    if line[0] == 'C':
                        shutil.copy2('Sources//input2.txt', ff+'//c'+str(c_counter)+'//c'+str(c_counter)+'.inp')
...
if platformname[0] == 'p' or platformname[0] == 'P' or  platformname[0] == 'Z':
...
elif platformname[0] == 't' or platformname == 'T':
...
with open('Sources//input2.txt','r') as batch:
    with open('Sources//input.txt','w') as batch2:
        for line in batch:
            batch2.write(line.replace(newTitleupper,'SadeghShokatian'))
batch.close()
batch2.close()

os.remove('Sources//input2.txt')
